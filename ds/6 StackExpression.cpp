...
public:
    ...
    string infix;
    Stack s;
    bool isoperator(char x)                               //operator cheking
    {                                                 
        if (x == '+' || x == '-' || x == '*' || x == '/' || x == '^')
            return true;
        else
    ...
    int precedance(string op)                            //precedance
    {
        if (op == "+" || op == "-")
            return 1;
        else if (op == "*" || op == "/")
    ...
    void infix_to_postfix()                               //Infix to postfix
    {
    ...
    void postfix_to_prefix()                                //postfix to prefix
    {
    ...
    void postfix_evaluation()                                 //Evaluation of postfix
    {
