/*Problem statement : Write a c++ program to apply the following 
transformation on the graphic object 1. Display the object 2. Translation 3. 
Scaling 4. Rotation 5. Reflection 6. Shear*/
...
int main() 
{ 
 initwindow(900,900,"manasi"); 
int s; 
 cout<<"=========select transformation you want=========\n1.Translation\n2.Rotation\n3.Scaling\n4.Reflection\n5.S hearing\n6.Exit "<<endl; cout<<"Selection:"; 
 cin>>s; 
switch(s) 
 { 
 case 1: 
...
line(x1,y1,x3,y3); line(x2,y2,x3,y3); 
